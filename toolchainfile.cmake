...
set(CMAKE_C_FLAGS "-D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64 -O3 -Wformat-security -Wall -Wextra -pie -fPIC -D_FORTIFY_SOURCE=2 -fstack-protector-strong" CACHE STRING "Buildroot CFLAGS")
set(CMAKE_CXX_FLAGS "-D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64 -O3 -Wformat-security -Wall -Wextra -pie -fPIC -D_FORTIFY_SOURCE=2 -fstack-protector-strong" CACHE STRING "Buildroot CXXFLAGS")
...
set(CMAKE_PROGRAM_PATH "$ENV{CROSS_COMPILER}/bin")
set(CMAKE_SYSROOT "$ENV{CROSS_COMPILER}/arm-buildroot-linux-musleabihf/sysroot")
set(CMAKE_FIND_ROOT_PATH "$ENV{CROSS_COMPILER}/arm-buildroot-linux-musleabihf/sysroot")
...
set(CMAKE_C_COMPILER "$ENV{CROSS_COMPILER}/bin/arm-buildroot-linux-musleabihf-gcc")
set(CMAKE_CXX_COMPILER "$ENV{CROSS_COMPILER}/bin/arm-buildroot-linux-musleabihf-g++")
