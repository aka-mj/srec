...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASECPPFLAGS': '',
 'BASEMODLIBS': '',
 'BINDIR': '/builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1/bin',
 'BINLIBDEST': '/builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1/lib/python3.11',
 'BLDLIBRARY': '-L. -lpython3.11',
 'BLDSHARED': '/usr/bin/gcc -std=gnu11 -pthread -shared '
              '-L/builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1/lib '
              '-Wl,-rpath,/builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1/lib '
              '-Wl,--enable-new-dtags',
 'BOOTSTRAP_HEADERS': '\\',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 ...
 'CFLAGS': '-Wsign-compare -DNDEBUG -g  -O3 -Wall -O2 '
           '-I/builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1/include',
 ...
 'CONFIGURE_CFLAGS_NODIST': '-std=c11 -Wextra -Wno-unused-parameter '
                            ...
                            '-fvisibility=hidden',
 'CONFIGURE_CPPFLAGS': '-I/builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1/include',
 'CONFIGURE_LDFLAGS': '-L/builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1/lib '
                      '-Wl,-rpath,/builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1/lib '
                      '-Wl,--enable-new-dtags',
 'CONFIGURE_LDFLAGS_NODIST': '',
 'CONFIGURE_LDFLAGS_NOLTO': '',
 'CONFIG_ARGS': "'--prefix=/builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1' "
                "'--sysconfdir=/builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1/etc' "
                "'--localstatedir=/builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1/var' "
                ...
                "'PKG_CONFIG=/builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1/bin/pkg-config' "
                "'PKG_CONFIG_LIBDIR=/builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1/lib/pkgconfig:/builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1/share/pkgconfig' "
                "'CC=/usr/bin/gcc' 'CFLAGS=-O2 "
                "-I/builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1/include' "
                "'LDFLAGS=-L/builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1/lib "
                '-Wl,-rpath,/builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1/lib '
                "-Wl,--enable-new-dtags' "
                "'CPPFLAGS=-I/builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1/include' "
                "'CPP=/usr/bin/cpp'",
 'CONFINCLUDEDIR': '/builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1/include',
 'CONFINCLUDEPY': '/builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1/include/python3.11',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/builds/buildroot.org/toolchains-builder/build/output/build/host-python3-3.11.6/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/builds/buildroot.org/toolchains-builder/build/output/build/host-python3-3.11.6/lcov-report',
 ...
 'DESTDIRS': '/builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1 '
             '/builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1/lib '
             '/builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1/lib/python3.11 '
             '/builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1/lib/python3.11/lib-dynload',
 'DESTLIB': '/builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1/lib/python3.11',
 'DESTPATH': '',
 'DESTSHARED': '/builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1/lib/python3.11/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1/include '
                   '/builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1/include '
                   '/builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1/include/python3.11 '
                   '/builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1/include/python3.11',
 'INCLUDEDIR': '/builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1/include',
 'INCLUDEPY': '/builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1/include/python3.11',
 ...
 'LDVERSION': '3.11',
 'LIBC': '',
 'LIBDEST': '/builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1/lib/python3.11',
 'LIBDIR': '/builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1/lib',
 ...
 'LIBEXPAT_HEADERS': '\\',
 'LIBEXPAT_OBJS': '\\',
 'LIBFFI_INCLUDEDIR': '/builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1/include',
 'LIBM': '-lm',
 ...
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1/lib/pkgconfig',
 'LIBPL': '/builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1/lib/python3.11/config-3.11-x86_64-linux-gnu',
 'LIBPYTHON': '',
 ...
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1/lib/python3.11',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAINCC': '/usr/bin/gcc -std=gnu11 -pthread',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 1,
 'MAKESETUP': './Modules/makesetup',
 'MANDIR': '/builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1/share/man',
 'MKDIR_P': '/bin/mkdir -p',
 ...
 'MODULE_BINASCII_CFLAGS': '-DUSE_ZLIB_CRC32 '
                           '-I/builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1/include',
 'MODULE_BINASCII_LDFLAGS': '-L/builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1/lib '
                            '-lz',
 ...
 'MODULE_ZLIB_CFLAGS': '-I/builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1/include',
 'MODULE_ZLIB_LDFLAGS': '-L/builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1/lib '
                        '-lz',
 ...
 'PY_CORE_CFLAGS': '-Wsign-compare -DNDEBUG -g  -O3 -Wall -O2 '
                   ...
                   '-I/builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1/include '
                   '-fPIC -DPy_BUILD_CORE',
 'PY_CORE_LDFLAGS': '-L/builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1/lib '
                    '-Wl,-rpath,/builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1/lib '
                    '-Wl,--enable-new-dtags',
 ...
 'PY_ENABLE_SHARED': 1,
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-L/builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1/lib '
               '-Wl,-rpath,/builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1/lib '
               '-Wl,--enable-new-dtags',
 'PY_LDFLAGS_NODIST': '',
 'PY_LDFLAGS_NOLTO': '-L/builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1/lib '
                     '-Wl,-rpath,/builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1/lib '
                     '-Wl,--enable-new-dtags',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/builds/buildroot.org/toolchains-builder/build/output/build/host-python3-3.11.6',
 'SCRIPTDIR': '/builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SHELL': '/bin/sh',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/builds/buildroot.org/toolchains-builder/build/output/build/host-python3-3.11.6 '
               './python -E',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/builds/buildroot.org/toolchains-builder/build/output/build/host-python3-3.11.6 '
 ...
 'VERSION': '3.11',
 'WASM_ASSETS_DIR': './builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1',
 'WASM_STDLIB': './builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1/lib/python3.11/os.py',
 'WHEEL_PKG_DIR': '',
 'WINDOW_HAS_FLAGS': 1,
 ...
 'abs_builddir': '/builds/buildroot.org/toolchains-builder/build/output/build/host-python3-3.11.6',
 'abs_srcdir': '/builds/buildroot.org/toolchains-builder/build/output/build/host-python3-3.11.6',
 'datarootdir': '/builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1/share',
 'exec_prefix': '/builds/buildroot.org/toolchains-builder/build/armv7-eabihf--musl--stable-2023.11-1',
